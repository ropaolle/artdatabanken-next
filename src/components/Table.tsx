...
export default function Table<Col, Row>({ columns, rows, hover, onRowClick, onSelectRow }: Props<Row, Col>) {
  const clickableRows = typeof onRowClick === "function";
  const selectable = typeof onSelectRow === "function";

  const tableOptions = { clickableRows, selectable, striped: true, defaultValue: "", hover: Boolean(hover) };
  const tableClasses = {
